#!/usr/bin/env python3
"""Script to clean up mixed date formats using mocked keyring.

This script uses an in-memory keyring to bypass the system keyring requirement.
"""
...
def fix_date_formats():
    ...
    try:
        ...
        with patch("utils.crypto.keyring", mock_keyring):
            # First, we need to set up a key in the mocked keyring
            ...
            if not crypto.key_exists():
                ...
                print("Using existing encryption key from mocked keyring")
            ...
            print("Database opened successfully with mocked keyring")
...
if __name__ == "__main__":
    print("=" * 60)
    print("RealTypeCoach Date Format Cleanup (Mocked Keyring)")
    print("=" * 60)
