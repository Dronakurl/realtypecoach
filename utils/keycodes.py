...
def is_letter_key(key_name: str) -> bool:
    """Check if a key name is a letter key (any language).
    ...
    # Use Unicode category to identify letters across all languages
    # Categories starting with 'L' are letters:
    # Lu = Uppercase, Ll = Lowercase, Lt = Titlecase, Lm = Modifier, Lo = Other
    category = unicodedata.category(key_name)
