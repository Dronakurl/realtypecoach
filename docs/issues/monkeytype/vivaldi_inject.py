...
def get_vivaldi_leveldb_path():
    ...
    possible_paths = [
        ...
        Path.home()
        / ".config/vivaldi/Default/Storage/ext/mpognobbkildjkofajifpdfhcoklimli/def/Local Storage/leveldb",
    ]
...
def inject_text_to_vivaldi(text: str, mode: str = "repeat"):
    ...
    try:
        db = plyvel.DB(
            str(leveldb_path), create_if_missing=False, write_buffer_size=16 * 1024 * 1024
        )
    ...
    try:
        ...
        for key, value in db.iterator(prefix=monkeytype_key_prefix):
            ...
            if "customTextSettings" in key_str:
                ...
                print("   Found existing customTextSettings:")
